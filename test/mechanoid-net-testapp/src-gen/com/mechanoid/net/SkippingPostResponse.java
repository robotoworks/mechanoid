...
public class SkippingPostResponse  {
	private String a;
	private int b;
	private long c;
	public String getA(){
	...
	public SkippingPostResponse(TransformerProvider provider, InputStream inStream) throws TransformException {
		JsonReader source = null;
		try {
			if(inStream != null) {
				source = new JsonReader(new InputStreamReader(inStream, Charset.defaultCharset()));
		
			SkippingPostResponse target = this;
