# -*- coding: utf-8 -*-
#
# Mechanoid documentation build configuration file, created by
# sphinx-quickstart on Tue Feb 19 15:45:20 2013.
#
...
project = u'Mechanoid'
copyright = u'2013, Robotoworks Limited'
...
htmlhelp_basename = 'Mechanoiddoc'
...
latex_documents = [
  ('index', 'Mechanoid.tex', u'Mechanoid Documentation',
   u'Robotoworks Limited', 'manual'),
]
...
man_pages = [
    ('index', 'mechanoid', u'Mechanoid Documentation',
     [u'Robotoworks Limited'], 1)
]
...
texinfo_documents = [
  ('index', 'Mechanoid', u'Mechanoid Documentation',
   u'Robotoworks Limited', 'Mechanoid', 'One line description of project.',
   'Miscellaneous'),
]
