...
public abstract class AbstractRecipesWithAuthorsByIdActions extends ContentProviderActions {
	@Override
	...
	public Cursor query(MechanoidContentProvider provider, Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder){
		...
		.expr(RecipesWithAuthors._ID, SQuery.Op.EQ, uri.getPathSegments().get(1))
		.append(selection, selectionArgs)
		.query(db, Tables.RECIPES_WITH_AUTHORS, projection, sortOrder);
	}
}
