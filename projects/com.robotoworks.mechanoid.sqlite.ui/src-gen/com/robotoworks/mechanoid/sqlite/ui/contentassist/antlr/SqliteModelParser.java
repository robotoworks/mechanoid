		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSelectAccess().getCompoundOperatorAssignment_1_1(), "rule__Select__CompoundOperatorAssignment_1_1");
					put(grammarAccess.getSelectAccess().getRightAssignment_1_2(), "rule__Select__RightAssignment_1_2");
