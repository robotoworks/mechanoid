		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatmentAccess().getGroup_3(), "rule__Statment__Group_3__0");
					put(grammarAccess.getStatmentAccess().getGroup_3_3(), "rule__Statment__Group_3_3__0");
					put(grammarAccess.getStatmentAccess().getGroup_4(), "rule__Statment__Group_4__0");
					put(grammarAccess.getStatmentAccess().getGroup_4_3(), "rule__Statment__Group_4_3__0");
					...
					put(grammarAccess.getStatmentAccess().getNameAssignment_3_4(), "rule__Statment__NameAssignment_3_4");
					put(grammarAccess.getStatmentAccess().getNameAssignment_4_4(), "rule__Statment__NameAssignment_4_4");
