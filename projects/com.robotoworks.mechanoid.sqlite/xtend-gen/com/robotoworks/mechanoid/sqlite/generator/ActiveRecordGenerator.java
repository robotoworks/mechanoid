...
public class ActiveRecordGenerator {
  public CharSequence generate(final Model model, final CreateTableStatement stmt) {
    ...
    _builder.append("Record select(ContentResolver resolver, long id) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t    ");
    ...
    String _name_29 = stmt.getName();
    String _pascalize_31 = Strings.pascalize(_name_29);
    _builder.append(_pascalize_31, "	");
    _builder.append("Record> select(ContentResolver resolver, SQuery query) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t    ");
    _builder.append("return select(resolver, query, null);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("Record> select(ContentResolver resolver, SQuery query, String sortOrder) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t    ");
    _builder.append("Cursor c = null;");
    _builder.newLine();
    ...
    String _pascalize_33 = Strings.pascalize(_name_31);
    _builder.append(_pascalize_33, "	    ");
    _builder.append("Record> items = new ArrayList<");
    String _name_32 = stmt.getName();
    String _pascalize_34 = Strings.pascalize(_name_32);
    ...
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("c = query.query(resolver, ");
    String _name_33 = stmt.getName();
    String _pascalize_35 = Strings.pascalize(_name_33);
    _builder.append(_pascalize_35, "	        ");
    _builder.append(".CONTENT_URI, PROJECTION, sortOrder);");
    _builder.newLineIfNotEmpty();
    _builder.append("\t        ");
    _builder.newLine();
    _builder.append("\t        ");
    ...
    _builder.newLine();
    _builder.append("\t            ");
    _builder.append("items.add(fromCursor(c));");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("}");
    _builder.newLine();
    ...
    String _pascalize_36 = Strings.pascalize(_name_34);
    _builder.append(_pascalize_36, "	");
    _builder.append("Record> select(ContentResolver resolver, String selection, String[] selectionArgs, String sortOrder) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t    ");
    _builder.append("Cursor c = null;");
    _builder.newLine();
    ...
    String _pascalize_37 = Strings.pascalize(_name_35);
    _builder.append(_pascalize_37, "	    ");
    _builder.append("Record> items = new ArrayList<");
    String _name_36 = stmt.getName();
    String _pascalize_38 = Strings.pascalize(_name_36);
    ...
    String _pascalize_39 = Strings.pascalize(_name_37);
    _builder.append(_pascalize_39, "	        ");
    _builder.append(".CONTENT_URI, PROJECTION, selection, selectionArgs, sortOrder);");
    _builder.newLineIfNotEmpty();
    _builder.append("\t        ");
    _builder.newLine();
    _builder.append("\t        ");
    ...
    String _pascalize_40 = Strings.pascalize(_name_38);
    _builder.append(_pascalize_40, "	");
    _builder.append("Record> select(ContentResolver resolver, String selection, String[] selectionArgs) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t    ");
    _builder.append("return select(resolver, selection, selectionArgs, null);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("\t");
    _builder.append("public static List<");
    String _name_39 = stmt.getName();
    String _pascalize_41 = Strings.pascalize(_name_39);
    _builder.append(_pascalize_41, "	");
    _builder.append("Record> select(ContentResolver resolver, String selection) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t    ");
    _builder.append("return select(resolver, selection, null, null);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("\t");
    _builder.append("public static List<");
    String _name_40 = stmt.getName();
    String _pascalize_42 = Strings.pascalize(_name_40);
    _builder.append(_pascalize_42, "	");
    _builder.append("Record> select(ContentResolver resolver) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t    ");
    _builder.append("return select(resolver, null, null, null);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("\t");
    _builder.append("public static ");
    String _name_41 = stmt.getName();
    String _pascalize_43 = Strings.pascalize(_name_41);
    _builder.append(_pascalize_43, "	");
    _builder.append("Record selectFirst(ContentResolver resolver, SQuery query) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("return selectFirst(resolver, query, null);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("\t");
    _builder.append("public static ");
    String _name_42 = stmt.getName();
    String _pascalize_44 = Strings.pascalize(_name_42);
    _builder.append(_pascalize_44, "	");
    _builder.append("Record selectFirst(ContentResolver resolver, SQuery query, String sortOrder) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t    ");
    _builder.append("Cursor c = null;");
    _builder.newLine();
    ...
    _builder.append("\t        ");
    _builder.append("c = query.query(resolver, ");
    String _name_43 = stmt.getName();
    String _pascalize_45 = Strings.pascalize(_name_43);
