  ...
  public CharSequence generate(final Model model, final MigrationBlock snapshot) {
    ...
    _builder.newLine();
    {
      ...
      for(final CreateTableStatement tbl_1 : _filter_3) {
        ...
        _builder.append("\t");
        _builder.append(" ");
        _builder.append("* <p>Column definitions and helper methods to work with ");
        ...
        String _name_10 = _database_2.getName();
        ...
        String _name_12 = _database_3.getName();
        ...
        _builder.newLine();
        {
          ...
          for(final ColumnDef col_2 : _filter_4) {
            ...
            String _underscore_1 = Strings.underscore(_name_15);
            String _upperCase_1 = _underscore_1.toUpperCase();
            _builder.append(_upperCase_1, "			");
            _builder.append(", ");
            String _name_16 = col_2.getName();
            String _camelize = Strings.camelize(_name_16);
        ...
        _builder.append("\t");
        _builder.append("\t ");
        _builder.append("* <p>Build and execute an insert or update statements for ");
        ...
        _builder.append("\t");
        _builder.append("\t");
        _builder.append("public static class Builder {");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("private ContentValues mValues = new ContentValues();");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.newLine();
        {
          ...
          for(final ColumnDef col_4 : _filter_6) {
            ...
            String _pascalize_8 = Strings.pascalize(_name_19);
            ...
            String _pascalize_9 = Strings.pascalize(_name_20);
            _builder.append(_pascalize_9, "				");
            _builder.append(".");
            String _name_21 = col_4.getName();
            String _underscore_2 = Strings.underscore(_name_21);
        ...
        String _pascalize_10 = Strings.pascalize(_name_22);
        ...
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("public Uri insert(ContentResolver contentResolver) {");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t\t");
        _builder.append("return contentResolver.insert(CONTENT_URI, mValues);");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("}");
        ...
        String _pascalize_11 = Strings.pascalize(_name_23);
        ...
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("public int update(ContentResolver contentResolver, SelectionQueryBuilder query) {");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t\t");
        ...
        _builder.newLine();
        {
          ...
          if (_hasAndroidPrimaryKey_1) {
            ...
            String _pascalize_12 = Strings.pascalize(_name_24);
            ...
            _builder.append("\t");
            _builder.append("\t\t");
            _builder.append("public int update(ContentResolver contentResolver, long id) {");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t\t");
            _builder.append("\t");
        ...
        String _pascalize_13 = Strings.pascalize(_name_25);
        ...
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("public ContentValues getValues() {");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t\t");
        _builder.append("return mValues;");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("}");
    ...
    _builder.newLine();
    {
      ...
      for(final CreateViewStatement vw_1 : _filter_7) {
        _builder.append("\t");
        _builder.append("public static class ");
        String _name_26 = vw_1.getName();
        String _pascalize_14 = Strings.pascalize(_name_26);
        _builder.append(_pascalize_14, "	");
        _builder.append(" implements ");
        String _name_27 = vw_1.getName();
        String _pascalize_15 = Strings.pascalize(_name_27);
        ...
        String _name_29 = _database_4.getName();
        String _lowerCase_3 = _name_29.toLowerCase();
        _builder.append(_lowerCase_3, "	            ");
        _builder.append(".");
        String _name_30 = vw_1.getName();
        _builder.append(_name_30, "	            ");
        _builder.append("\";");
        _builder.newLineIfNotEmpty();
        {
          boolean _hasAndroidPrimaryKey_3 = Extensions.hasAndroidPrimaryKey(vw_1);
          if (_hasAndroidPrimaryKey_3) {
            ...
            String _name_31 = _database_5.getName();
            String _lowerCase_4 = _name_31.toLowerCase();
      ...
      if (_notEquals) {
        {
          ...
          for(final ActionStatement action : _actions_2) {
            _builder.append("\t");
            _builder.append("public static class ");
            String _name_33 = action.getName();
            String _pascalize_16 = Strings.pascalize(_name_33);
            ...
            String _lowerCase_5 = _name_34.toLowerCase();
            _builder.append(_lowerCase_5, "	            ");
            _builder.append(".");
            String _name_35 = action.getName();
    ...
    String _name_36 = _database_9.getName();
    String _pascalize_17 = Strings.pascalize(_name_36);
