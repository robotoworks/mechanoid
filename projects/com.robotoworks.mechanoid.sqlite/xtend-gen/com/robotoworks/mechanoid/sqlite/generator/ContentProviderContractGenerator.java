  ...
  public CharSequence generate(final Model model, final MigrationBlock snapshot) {
    ...
    _builder.newLine();
    {
      ...
      for(final CreateTableStatement tbl_1 : _filter_3) {
        ...
        String _pascalize_6 = Strings.pascalize(_name_10);
        ...
        String _name_14 = _database_3.getName();
        ...
        String _name_17 = _database_4.getName();
        String _lowerCase_4 = _name_17.toLowerCase();
        _builder.append(_lowerCase_4, "		 ");
        _builder.append("/");
        String _name_18 = tbl_1.getName();
        String _lowerCase_5 = _name_18.toLowerCase();
        ...
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("public Uri insert() {");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t\t");
        ...
        _builder.append("\t");
        _builder.append("\t\t\t");
        _builder.append("return resolver.insert(CONTENT_URI, mValues);");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("}");
        ...
        _builder.append("\t");
        _builder.append("\t\t\t");
        _builder.append("return resolver.update(CONTENT_URI, mValues, query.toString(), query.getArgsArray());");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("}");
        ...
        _builder.newLine();
        {
          ...
          if (_hasAndroidPrimaryKey_1) {
            ...
            _builder.append("\t");
            _builder.append("\t\t");
            _builder.append("public int update(long id) {");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t\t");
            _builder.append("\t");
            ...
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.append("return resolver.update(CONTENT_URI.buildUpon().appendPath(String.valueOf(id)).build(), mValues, null, null);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t\t");
            _builder.append("}");
        ...
        _builder.append("\t");
        _builder.append("\t\t ");
        _builder.append("* @see ContentProviderOperation.newInsert(Uri)");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t ");
        _builder.append("*/\t\t\t\t\t\t\t\t");
        ...
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("public ContentProviderOperation newInsertOperation() {");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t\t");
        _builder.append("return ContentProviderOperation.newInsert(CONTENT_URI);");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("}");
        ...
        _builder.append("\t");
        _builder.append("\t\t ");
        _builder.append("* @see ContentProviderOperation.newUpdate(Uri)");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t ");
        _builder.append("*/");
        ...
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("public ContentProviderOperation newUpdateOperation() {");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t\t");
        _builder.append("return ContentProviderOperation.newUpdate(CONTENT_URI);");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("}");
        ...
        _builder.append("\t");
        _builder.append("\t\t ");
        _builder.append("* @see ContentProviderOperation.newDelete(Uri)");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t ");
        _builder.append("*/");
        ...
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("public ContentProviderOperation newDeleteOperation() {");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t\t");
        _builder.append("return ContentProviderOperation.newDelete(CONTENT_URI);");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("}");
        ...
        _builder.append("\t");
        _builder.append("\t\t ");
        _builder.append("* @see ContentProviderOperation.newAssertQuery(Uri)");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t ");
        _builder.append("*/");
        ...
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("public ContentProviderOperation newAssertQueryOperation() {");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t\t");
        _builder.append("return ContentProviderOperation.newAssertQuery(CONTENT_URI);");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("}");
