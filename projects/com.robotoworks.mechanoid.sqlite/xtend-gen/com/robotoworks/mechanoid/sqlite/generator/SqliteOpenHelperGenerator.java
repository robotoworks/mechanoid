...
public class SqliteOpenHelperGenerator {
  ...
  public CharSequence generate(final Model model, final MigrationBlock snapshot) {
    ...
    EList<MigrationBlock> _migrations = _database_2.getMigrations();
    ...
    _builder.newLine();
    {
      ...
      EList<MigrationBlock> _migrations_1 = _database_4.getMigrations();
      int _size_1 = _migrations_1.size();
      ...
      if (_greaterThan) {
        ...
        _builder.newLine();
        {
          ...
          Iterable<MigrationBlock> _drop = IterableExtensions.<MigrationBlock>drop(_migrations_2, 1);
