...
public interface SqliteModelPackage extends EPackage
{
   ...
   * @generated
   */
  int UPDATE_COLUMN_EXPRESSION = 13;
   ...
   * @ordered
   */
  int SELECT_STATEMENT__CORE_STATEMENTS = DML_STATEMENT_FEATURE_COUNT + 0;
  ...
  /**
   * The meta object id for the '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.impl.TableSourceImpl <em>Table Source</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.impl.TableSourceImpl
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.impl.SqliteModelPackageImpl#getTableSource()
   * @generated
   */
  int TABLE_SOURCE = 29;
   ...
   * @ordered
   */
  int TABLE_SOURCE__TABLE_ALIAS = 1;

  /**
   * The number of structural features of the '<em>Table Source</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int TABLE_SOURCE_FEATURE_COUNT = 2;
   ...
   * @ordered
   */
  int ACTION_STATEMENT__PATH = CONFIGURATION_STATEMENT_FEATURE_COUNT + 0;
  ...
  /**
   * The meta object id for the '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.impl.ActiveRecordRegistrationStatementImpl <em>Active Record Registration Statement</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.impl.ActiveRecordRegistrationStatementImpl
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.impl.SqliteModelPackageImpl#getActiveRecordRegistrationStatement()
   * @generated
   */
  int ACTIVE_RECORD_REGISTRATION_STATEMENT = 31;
   ...
   * @ordered
   */
  int ACTIVE_RECORD_REGISTRATION_STATEMENT__NAME = CONFIGURATION_STATEMENT__NAME;

  /**
   * The number of structural features of the '<em>Active Record Registration Statement</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ACTIVE_RECORD_REGISTRATION_STATEMENT_FEATURE_COUNT = CONFIGURATION_STATEMENT_FEATURE_COUNT + 0;
   ...
   * @generated
   */
  int SELECT_STATEMENT_EXPRESSION = 42;
   ...
   * @ordered
   */
  int CAST_EXPRESSION__ISNULL = EXPRESSION_FEATURE_COUNT + 2;
   ...
   * @generated
   */
  int CREATE_TRIGGER_STATEMENT = 48;
   ...
   * @ordered
   */
  int CREATE_TRIGGER_STATEMENT__UPDATE_COLUMN_NAMES = DDL_STATEMENT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int CREATE_TRIGGER_STATEMENT__TABLE_NAME = DDL_STATEMENT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int CREATE_TRIGGER_STATEMENT__WHEN_EXPRESSION = DDL_STATEMENT_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int CREATE_TRIGGER_STATEMENT__STATEMENTS = DDL_STATEMENT_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int CREATE_TRIGGER_STATEMENT_FEATURE_COUNT = DDL_STATEMENT_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
  int DROP_TABLE_STATEMENT_FEATURE_COUNT = DDL_STATEMENT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int DROP_TRIGGER_STATEMENT_FEATURE_COUNT = DDL_STATEMENT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int DROP_VIEW_STATEMENT_FEATURE_COUNT = DDL_STATEMENT_FEATURE_COUNT + 0;
   ...
   * @generated
   */
  int ALTER_TABLE_RENAME_CLAUSE = 53;
   ...
   * @generated
   */
  int ALTER_TABLE_ADD_COLUMN_CLAUSE = 54;
   ...
   * @generated
   */
  int PRIMARY_KEY_COLUMN_CONSTRAINT = 55;
   ...
   * @generated
   */
  int EXPRESSION_DEFAULT_VALUE = 59;
   ...
   * @ordered
   */
  int SINGLE_SOURCE_TABLE__SOURCE = SINGLE_SOURCE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int SINGLE_SOURCE_TABLE_FEATURE_COUNT = SINGLE_SOURCE_FEATURE_COUNT + 1;
   ...
   * @generated
   */
  int SINGLE_SOURCE_SELECT_STATEMENT = 64;
  ...
  /**
   * Returns the meta object for the attribute '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.ConfigurationStatement#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.ConfigurationStatement#getName()
  ...
  /**
   * Returns the meta object for class '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.TableSource <em>Table Source</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Table Source</em>'.
  ...
  /**
   * Returns the meta object for the reference '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.TableSource#getTable <em>Table</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Table</em>'.
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.TableSource#getTable()
   * @see #getTableSource()
   * @generated
   */
  EReference getTableSource_Table();

  /**
   * Returns the meta object for the attribute '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.TableSource#getTableAlias <em>Table Alias</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Table Alias</em>'.
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.TableSource#getTableAlias()
   * @see #getTableSource()
   * @generated
   */
  EAttribute getTableSource_TableAlias();
  ...
  /**
   * Returns the meta object for class '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.ActiveRecordRegistrationStatement <em>Active Record Registration Statement</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Active Record Registration Statement</em>'.
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.ActiveRecordRegistrationStatement
   * @generated
   */
  EClass getActiveRecordRegistrationStatement();
  ...
  /**
   * Returns the meta object for the attribute '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.CastExpression#isIsnull <em>Isnull</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Isnull</em>'.
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.CastExpression#isIsnull()
   * @see #getCastExpression()
   * @generated
   */
  EAttribute getCastExpression_Isnull();
  ...
  /**
   * Returns the meta object for the containment reference '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.SingleSourceTable#getSource <em>Source</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Source</em>'.
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.SingleSourceTable#getSource()
   * @see #getSingleSourceTable()
   * @generated
   */
  EReference getSingleSourceTable_Source();
  ...
  /**
   * Returns the meta object for the reference '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.ResultColumnAll#getTable <em>Table</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Table</em>'.
   ...
   * @generated
   */
  EReference getResultColumnAll_Table();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.impl.TableSourceImpl <em>Table Source</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see com.robotoworks.mechanoid.sqlite.sqliteModel.impl.TableSourceImpl
     * @see com.robotoworks.mechanoid.sqlite.sqliteModel.impl.SqliteModelPackageImpl#getTableSource()
     ...
     * @generated
     */
    EReference TABLE_SOURCE__TABLE = eINSTANCE.getTableSource_Table();
     ...
     * @generated
     */
    EAttribute TABLE_SOURCE__TABLE_ALIAS = eINSTANCE.getTableSource_TableAlias();
    ...
    /**
     * The meta object literal for the '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.impl.ActiveRecordRegistrationStatementImpl <em>Active Record Registration Statement</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see com.robotoworks.mechanoid.sqlite.sqliteModel.impl.ActiveRecordRegistrationStatementImpl
     * @see com.robotoworks.mechanoid.sqlite.sqliteModel.impl.SqliteModelPackageImpl#getActiveRecordRegistrationStatement()
     * @generated
     */
    EClass ACTIVE_RECORD_REGISTRATION_STATEMENT = eINSTANCE.getActiveRecordRegistrationStatement();
     ...
     * @generated
     */
    EAttribute CAST_EXPRESSION__ISNULL = eINSTANCE.getCastExpression_Isnull();
     ...
     * @generated
     */
    EReference SINGLE_SOURCE_TABLE__SOURCE = eINSTANCE.getSingleSourceTable_Source();
     ...
     * @generated
     */
    EReference RESULT_COLUMN_ALL__TABLE = eINSTANCE.getResultColumnAll_Table();
