...
public class ArrayOutputTransformerGenerator {
  ...
  public CharSequence generate(final ComplexTypeDeclaration decl, final Model module) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("\u00B4var body = generateArrayOutputTransformerGeneratorClass(decl, module)\u00AA");
    _builder.newLine();
  ...
  public CharSequence generateArrayOutputTransformerGeneratorClass(final ComplexTypeDeclaration decl, final Model module) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("\u00B4context.registerImport(\"org.json.JSONArray\")\u00AA");
    _builder.newLine();
    _builder.append("\u00B4context.registerImport(\"org.json.JSONObject\")\u00AA");
    _builder.newLine();
    _builder.append("public class \u00B4decl.name\u00AAArrayOutputTransformer extends Transformer<\u00B4decl.name\u00AA[], JSONArray> {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public void transform(\u00B4decl.name\u00AA[] source, JSONArray target) throws TransformException {");
    _builder.newLine();
    _builder.append("\t\t");
