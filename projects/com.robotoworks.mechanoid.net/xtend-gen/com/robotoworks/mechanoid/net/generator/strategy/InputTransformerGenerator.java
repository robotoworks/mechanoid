...
public class InputTransformerGenerator {
  ...
  public CharSequence generate(final ComplexTypeDeclaration decl, final Model module) {
    ...
    _builder.newLine();
    _builder.append("import com.robotoworks.mechanoid.internal.util.JsonUtil;");
    _builder.newLine();
    _builder.append("import com.robotoworks.mechanoid.internal.util.JsonToken;");
    _builder.newLine();
