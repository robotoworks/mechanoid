...
public class ListOutputTransformerGenerator {
  ...
  public CharSequence generateListOutputTransformerGeneratorClass(final ComplexTypeDeclaration decl, final Model module) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("public JSONArray transform(List<");
    String _name_2 = decl.getName();
    _builder.append(_name_2, "	");
    _builder.append("> source) throws TransformException {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("transform(source, target);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    _builder.append("JSONObject targetItem = itemTransformer.transform(sourceItem);");
    _builder.newLine();
    _builder.append("\t\t\t");
