...
public class ArrayInputTransformerGenerator {
  ...
  public CharSequence generate(final ComplexTypeDeclaration decl, final Model module) {
    ...
    _builder.newLine();
    CharSequence body = this.generateArrayInputTransformerGeneratorClass(decl, module);
    _builder.newLineIfNotEmpty();
  ...
  public CharSequence generateArrayInputTransformerGeneratorClass(final ComplexTypeDeclaration decl, final Model module) {
    ...
    _builder.append("ArrayInputTransformer extends Transformer<JSONArray, ");
    String _name_1 = decl.getName();
    _builder.append(_name_1, "");
    _builder.append("[]> {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("public void transform(JSONArray source, ");
