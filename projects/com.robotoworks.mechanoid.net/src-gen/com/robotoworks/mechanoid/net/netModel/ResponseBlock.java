 ...
 * <ul>
 *   <li>{@link com.robotoworks.mechanoid.net.netModel.ResponseBlock#getName <em>Name</em>}</li>
...
public interface ResponseBlock extends EObject
{
   ...
   * @see #setName(String)
   * @see com.robotoworks.mechanoid.net.netModel.NetModelPackage#getResponseBlock_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link com.robotoworks.mechanoid.net.netModel.ResponseBlock#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
