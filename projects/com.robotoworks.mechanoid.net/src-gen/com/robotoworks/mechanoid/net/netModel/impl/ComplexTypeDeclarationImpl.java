 ...
 * <ul>
 *   <li>{@link com.robotoworks.mechanoid.net.netModel.impl.ComplexTypeDeclarationImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComplexTypeDeclarationImpl extends UserTypeDeclarationImpl implements ComplexTypeDeclaration
{
  ...
  {
    return NetModelPackage.Literals.COMPLEX_TYPE_DECLARATION;
  }
  ...
  public void setLiteral(ComplexTypeLiteral newLiteral)
  {
    if (newLiteral != literal)
    {
      ...
      if (literal != null)
        msgs = ((InternalEObject)literal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NetModelPackage.COMPLEX_TYPE_DECLARATION__LITERAL, null, msgs);
      if (newLiteral != null)
        msgs = ((InternalEObject)newLiteral).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NetModelPackage.COMPLEX_TYPE_DECLARATION__LITERAL, null, msgs);
      msgs = basicSetLiteral(newLiteral, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, NetModelPackage.COMPLEX_TYPE_DECLARATION__LITERAL, newLiteral, newLiteral));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case NetModelPackage.COMPLEX_TYPE_DECLARATION__LITERAL:
