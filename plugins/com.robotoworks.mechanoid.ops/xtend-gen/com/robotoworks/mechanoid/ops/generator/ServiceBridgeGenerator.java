...
public class ServiceBridgeGenerator {
  public CharSequence generate(final Model model) {
    ...
    String _formatServiceBridgeName = Extensions.formatServiceBridgeName(_name_1);
    _builder.append(_formatServiceBridgeName, "");
    _builder.append(" extends OperationServiceBridge {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    ...
    String _formatServiceBridgeName_1 = Extensions.formatServiceBridgeName(_name_3);
    _builder.append(_formatServiceBridgeName_1, "	");
            ...
            if ((_uniqueClause_1 instanceof UniqueDeclaration)) {
              ...
              _builder.newLine();
              {
                ...
                for(final OperationArg uarg : _args_2) {
                  ...
                  String _pascalize_4 = Strings.pascalize(_name_11);
  ...
  public CharSequence generateStub(final Model model) {
    ...
    String _name = svc.getName();
    String _formatServiceBridgeName = Extensions.formatServiceBridgeName(_name);
    _builder.append(_formatServiceBridgeName, "");
    _builder.append(" extends Abstract");
    String _name_1 = svc.getName();
    String _formatServiceBridgeName_1 = Extensions.formatServiceBridgeName(_name_1);
    _builder.append(_formatServiceBridgeName_1, "");
    _builder.append(" {");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    ...
    String _name_2 = svc.getName();
    String _formatServiceBridgeName_2 = Extensions.formatServiceBridgeName(_name_2);
    _builder.append(_formatServiceBridgeName_2, "	");
    ...
    String _name_3 = svc.getName();
    String _formatServiceBridgeName_3 = Extensions.formatServiceBridgeName(_name_3);
    _builder.append(_formatServiceBridgeName_3, "	");
    ...
    String _formatServiceBridgeName_4 = Extensions.formatServiceBridgeName(_name_4);
    _builder.append(_formatServiceBridgeName_4, "			");
    _builder.append("();");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("} ");
    ...
    String _formatServiceBridgeName_5 = Extensions.formatServiceBridgeName(_name_5);
    _builder.append(_formatServiceBridgeName_5, "	");
    _builder.append("(){");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
