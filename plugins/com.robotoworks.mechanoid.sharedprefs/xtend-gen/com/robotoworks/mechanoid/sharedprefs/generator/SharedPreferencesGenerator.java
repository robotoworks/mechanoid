  ...
  public CharSequence generate(final Model model) {
    ...
    _builder.newLine();
    {
      ...
      for(final Preference p_1 : _prefs_1) {
        ...
        _builder.append(", ");
        PreferenceType _type_2 = p_1.getType();
        String _defaultValue = Extensions.getDefaultValue(_type_2);
    ...
    _builder.newLine();
    {
      ...
      for(final Preference p_2 : _prefs_2) {
        ...
        PreferenceType _type_4 = p_2.getType();
        String _putMethodName = Extensions.toPutMethodName(_type_4);
