...
public class SharedPreferencesModelJavaValidator extends AbstractSharedPreferencesModelJavaValidator {
    ...
    @Inject
    MechanoidLibClasspathValidationHelper libValidationHelper;
    ...
    public void checkMechanoidLibOnClasspath(Model m) {
        if (libValidationHelper.shouldValidateMechanoidLibOnClassPath(m)) {
            ...
            if (type == null) {
                error("mechanoid.jar is required in your /libs folder or on the classpath", SharedPreferencesModelPackage.Literals
                        .MODEL__PACKAGE_NAME, MechanoidIssueCodes.MISSING_MECHANOID_LIBS);
            }
        }
    }
