 ...
 * <ul>
 *   <li>{@link com.robotoworks.mechanoid.db.sqliteModel.NotNullConstraint#getConflictClause <em>Conflict Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.robotoworks.mechanoid.db.sqliteModel.SqliteModelPackage#getNotNullConstraint()
 * @model
 * @generated
 */
public interface NotNullConstraint extends ColumnConstraint
{
   ...
   * @see com.robotoworks.mechanoid.db.sqliteModel.SqliteModelPackage#getNotNullConstraint_ConflictClause()
  ...
  /**
   * Sets the value of the '{@link com.robotoworks.mechanoid.db.sqliteModel.NotNullConstraint#getConflictClause <em>Conflict Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
