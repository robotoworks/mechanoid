 ...
 * </p>
 * <ul>
 *   <li>{@link com.robotoworks.mechanoid.db.sqliteModel.impl.InitBlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InitBlockImpl extends MinimalEObjectImpl.Container implements InitBlock
{
  ...
  {
    return SqliteModelPackage.Literals.INIT_BLOCK;
  }
  ...
  public EList<DDLStatement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<DDLStatement>(DDLStatement.class, this, SqliteModelPackage.INIT_BLOCK__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SqliteModelPackage.INIT_BLOCK__STATEMENTS:
