...
class ContentProviderGenerator {
		def CharSequence generate(Model model, MigrationBlock snapshot) '''
			...
			import com.example.app1.db.AbstractÇmodel.database.name.pascalizeÈOpenHelper.Tables;
			...
			public abstract class AbstractÇmodel.database.name.pascalizeÈContentProvider extends MechanoidContentProvider {
			    ...
			    protected ContentProviderActions createÇtbl.name.pascalizeÈByIdActions() {
			    	return new DefaultContentProviderActions(Tables.Çtbl.name.underscore.toUpperCaseÈ, Çtbl.name.pascalizeÈRecord.getFactory());
			    }
			    ...
			    protected ContentProviderActions createÇview.name.pascalizeÈByIdActions() {
			    	return new DefaultContentProviderActions(Tables.Çview.name.underscore.toUpperCaseÈ);
			    }
