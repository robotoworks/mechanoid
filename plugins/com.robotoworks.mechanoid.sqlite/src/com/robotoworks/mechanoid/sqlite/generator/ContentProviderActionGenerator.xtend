...
class ContentProviderActionGenerator {
		def dispatch CharSequence generate(Model model, CreateTableStatement tbl, boolean forId) '''
			...
			public class Default«tbl.name.pascalize»«IF forId»ById«ENDIF»Actions extends ContentProviderActions {
				@Override
		...
		public class Default«vw.name.pascalize»«IF forId»ById«ENDIF»Actions extends ContentProviderActions {
			@Override
			public int delete(MechanoidContentProvider provider, Uri uri, String selection, String[] selectionArgs){
				return -1;
			}
		...
		public class Default«action.name.pascalize»Actions extends ContentProviderActions {
