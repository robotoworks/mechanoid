...
public class XSqliteModelScopeProvider extends SqliteModelScopeProvider {
  public IScope scope_IndexedColumn_columnReference(final IndexedColumn context, final EReference reference) {
    EObject _eContainer = context.eContainer();
    EObject _eContainer_1 = _eContainer.eContainer();
    TreeIterator<EObject> _eAllContents = _eContainer_1.eAllContents();
