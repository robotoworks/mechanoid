 ...
 * </p>
 *
 * @see com.robotoworks.mechanoid.sqlite.sqliteModel.SqliteModelPackage#getDropViewStatement()
 * @model
 * @generated
 */
public interface DropViewStatement extends DDLStatement
{
   ...
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.SqliteModelPackage#getDropViewStatement_IfExists()
   * @model
   * @generated
   */
  boolean isIfExists();
  ...
  /**
   * Sets the value of the '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.DropViewStatement#isIfExists <em>If Exists</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
