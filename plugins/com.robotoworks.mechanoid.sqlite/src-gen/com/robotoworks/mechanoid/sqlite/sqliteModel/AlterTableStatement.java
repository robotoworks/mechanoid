 ...
 * <ul>
 *   <li>{@link com.robotoworks.mechanoid.sqlite.sqliteModel.AlterTableStatement#getTable <em>Table</em>}</li>
...
public interface AlterTableStatement extends DDLStatement
{
   ...
   * @see com.robotoworks.mechanoid.sqlite.sqliteModel.SqliteModelPackage#getAlterTableStatement_Table()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.robotoworks.mechanoid.sqlite.sqliteModel.AlterTableStatement#getTable <em>Table</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
