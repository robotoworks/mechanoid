 ...
 * <ul>
 *   <li>{@link com.robotoworks.mechanoid.sqlite.sqliteModel.impl.ColumnSourceImpl#getSource <em>Source</em>}</li>
 *   <li>{@link com.robotoworks.mechanoid.sqlite.sqliteModel.impl.ColumnSourceImpl#getColumn <em>Column</em>}</li>
 ...
 * @generated
 */
public class ColumnSourceImpl extends ExpressionImpl implements ColumnSource
{
  /**
    ...
    if (source != null && source.eIsProxy())
    {
      ...
      if (source != oldSource)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SqliteModelPackage.COLUMN_SOURCE__SOURCE, oldSource, source));
      }
    }
    return source;
  }
  ...
  public void setSource(SelectSource newSource)
  {
    ...
    source = newSource;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SqliteModelPackage.COLUMN_SOURCE__SOURCE, oldSource, source));
  }
  ...
  public ColumnSource getColumn()
  {
    if (column != null && column.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SqliteModelPackage.COLUMN_SOURCE__COLUMN, oldColumn, column));
      }
    }
    return column;
  }
  ...
  public void setColumn(ColumnSource newColumn)
  {
    ...
    column = newColumn;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SqliteModelPackage.COLUMN_SOURCE__COLUMN, oldColumn, column));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SqliteModelPackage.COLUMN_SOURCE__SOURCE:
        if (resolve) return getSource();
        return basicGetSource();
      case SqliteModelPackage.COLUMN_SOURCE__COLUMN:
