...
public class SqliteModelParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected com.robotoworks.mechanoid.sqlite.parser.antlr.internal.InternalSqliteModelParser createParser(XtextTokenStream stream) {
		return new com.robotoworks.mechanoid.sqlite.parser.antlr.internal.InternalSqliteModelParser(stream, getGrammarAccess());
	}
