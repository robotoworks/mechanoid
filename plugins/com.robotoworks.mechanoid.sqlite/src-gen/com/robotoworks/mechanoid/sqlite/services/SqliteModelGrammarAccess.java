...
public class SqliteModelGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class PrimaryExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final Action cAllColumnsAction_2_0 = (Action)cGroup_2.eContents().get(0);
		private final Assignment cSourceAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final CrossReference cSourceSelectSourceCrossReference_2_1_0 = (CrossReference)cSourceAssignment_2_1.eContents().get(0);
		private final RuleCall cSourceSelectSourceIDTerminalRuleCall_2_1_0_1 = (RuleCall)cSourceSelectSourceCrossReference_2_1_0.eContents().get(1);
		...
		private final RuleCall cLiteralValueLiteralValueParserRuleCall_4_1_0 = (RuleCall)cLiteralValueAssignment_4_1.eContents().get(0);
		private final Group cGroup_5 = (Group)cAlternatives.eContents().get(5);
		private final Action cNestedExpressionAction_5_0 = (Action)cGroup_5.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_5_1 = (Keyword)cGroup_5.eContents().get(1);
		private final Assignment cExpressionAssignment_5_2 = (Assignment)cGroup_5.eContents().get(2);
		private final RuleCall cExpressionSqlExpressionParserRuleCall_5_2_0 = (RuleCall)cExpressionAssignment_5_2.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_5_3 = (Keyword)cGroup_5.eContents().get(3);
		private final Group cGroup_6 = (Group)cAlternatives.eContents().get(6);
		private final Action cSelectStatementExpressionAction_6_0 = (Action)cGroup_6.eContents().get(0);
		private final Assignment cNotAssignment_6_1 = (Assignment)cGroup_6.eContents().get(1);
		private final Keyword cNotNotKeyword_6_1_0 = (Keyword)cNotAssignment_6_1.eContents().get(0);
		private final Assignment cExistsAssignment_6_2 = (Assignment)cGroup_6.eContents().get(2);
		private final Keyword cExistsExistsKeyword_6_2_0 = (Keyword)cExistsAssignment_6_2.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_6_3 = (Keyword)cGroup_6.eContents().get(3);
		private final Assignment cSelectAssignment_6_4 = (Assignment)cGroup_6.eContents().get(4);
		private final RuleCall cSelectSelectStatementParserRuleCall_6_4_0 = (RuleCall)cSelectAssignment_6_4.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_6_5 = (Keyword)cGroup_6.eContents().get(5);
		private final Group cGroup_7 = (Group)cAlternatives.eContents().get(7);
		private final Action cCaseExpressionAction_7_0 = (Action)cGroup_7.eContents().get(0);
		private final Keyword cCaseKeyword_7_1 = (Keyword)cGroup_7.eContents().get(1);
		private final Assignment cCaseExpressionAssignment_7_2 = (Assignment)cGroup_7.eContents().get(2);
		private final RuleCall cCaseExpressionSqlExpressionParserRuleCall_7_2_0 = (RuleCall)cCaseExpressionAssignment_7_2.eContents().get(0);
		private final Assignment cCasesAssignment_7_3 = (Assignment)cGroup_7.eContents().get(3);
		private final RuleCall cCasesCaseParserRuleCall_7_3_0 = (RuleCall)cCasesAssignment_7_3.eContents().get(0);
		private final Group cGroup_7_4 = (Group)cGroup_7.eContents().get(4);
		private final Keyword cElseKeyword_7_4_0 = (Keyword)cGroup_7_4.eContents().get(0);
		private final Assignment cElseExpressionAssignment_7_4_1 = (Assignment)cGroup_7_4.eContents().get(1);
		private final RuleCall cElseExpressionSqlExpressionParserRuleCall_7_4_1_0 = (RuleCall)cElseExpressionAssignment_7_4_1.eContents().get(0);
		private final Keyword cEndKeyword_7_5 = (Keyword)cGroup_7.eContents().get(5);
		private final Group cGroup_8 = (Group)cAlternatives.eContents().get(8);
		private final Action cFunctionAction_8_0 = (Action)cGroup_8.eContents().get(0);
		...
		private final Assignment cAllAssignment_8_3_0 = (Assignment)cAlternatives_8_3.eContents().get(0);
		private final Keyword cAllAsteriskKeyword_8_3_0_0 = (Keyword)cAllAssignment_8_3_0.eContents().get(0);
		private final Group cGroup_8_3_1 = (Group)cAlternatives_8_3.eContents().get(1);
		private final Assignment cArgumentsAssignment_8_3_1_0 = (Assignment)cGroup_8_3_1.eContents().get(0);
		private final RuleCall cArgumentsSqlExpressionParserRuleCall_8_3_1_0_0 = (RuleCall)cArgumentsAssignment_8_3_1_0.eContents().get(0);
		...
		private final Assignment cArgumentsAssignment_8_3_1_1_1 = (Assignment)cGroup_8_3_1_1.eContents().get(1);
		private final RuleCall cArgumentsSqlExpressionParserRuleCall_8_3_1_1_1_0 = (RuleCall)cArgumentsAssignment_8_3_1_1_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_8_4 = (Keyword)cGroup_8.eContents().get(4);
		private final Group cGroup_9 = (Group)cAlternatives.eContents().get(9);
		private final Action cCastExpressionAction_9_0 = (Action)cGroup_9.eContents().get(0);
		private final Keyword cCastKeyword_9_1 = (Keyword)cGroup_9.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_9_2 = (Keyword)cGroup_9.eContents().get(2);
		private final Assignment cExpressionAssignment_9_3 = (Assignment)cGroup_9.eContents().get(3);
		private final RuleCall cExpressionSqlExpressionParserRuleCall_9_3_0 = (RuleCall)cExpressionAssignment_9_3.eContents().get(0);
		private final Keyword cAsKeyword_9_4 = (Keyword)cGroup_9.eContents().get(4);
		private final Assignment cTypeAssignment_9_5 = (Assignment)cGroup_9.eContents().get(5);
		private final RuleCall cTypeSqliteDataTypeEnumRuleCall_9_5_0 = (RuleCall)cTypeAssignment_9_5.eContents().get(0);
		...
		//{AllColumns} source=[SelectSource] "." "*"
		public Group getGroup_2() { return cGroup_2; }

		//{AllColumns}
		public Action getAllColumnsAction_2_0() { return cAllColumnsAction_2_0; }

		//source=[SelectSource]
		public Assignment getSourceAssignment_2_1() { return cSourceAssignment_2_1; }

		//[SelectSource]
		public CrossReference getSourceSelectSourceCrossReference_2_1_0() { return cSourceSelectSourceCrossReference_2_1_0; }

		//ID
		public RuleCall getSourceSelectSourceIDTerminalRuleCall_2_1_0_1() { return cSourceSelectSourceIDTerminalRuleCall_2_1_0_1; }
		...
		public Assignment getLiteralValueAssignment_4_1() { return cLiteralValueAssignment_4_1; }

		//LiteralValue
		public RuleCall getLiteralValueLiteralValueParserRuleCall_4_1_0() { return cLiteralValueLiteralValueParserRuleCall_4_1_0; }

		//{NestedExpression} "(" expression=SqlExpression ")"
		public Group getGroup_5() { return cGroup_5; }

		//{NestedExpression}
		public Action getNestedExpressionAction_5_0() { return cNestedExpressionAction_5_0; }
		...
		//SqlExpression
		public RuleCall getExpressionSqlExpressionParserRuleCall_5_2_0() { return cExpressionSqlExpressionParserRuleCall_5_2_0; }
		...
		public Action getSelectStatementExpressionAction_6_0() { return cSelectStatementExpressionAction_6_0; }

		//not?="not"?
		public Assignment getNotAssignment_6_1() { return cNotAssignment_6_1; }

		//"not"
		public Keyword getNotNotKeyword_6_1_0() { return cNotNotKeyword_6_1_0; }

		//exists?="exists"?
		public Assignment getExistsAssignment_6_2() { return cExistsAssignment_6_2; }

		//"exists"
		public Keyword getExistsExistsKeyword_6_2_0() { return cExistsExistsKeyword_6_2_0; }

		//"("
		public Keyword getLeftParenthesisKeyword_6_3() { return cLeftParenthesisKeyword_6_3; }

		//select=SelectStatement
		public Assignment getSelectAssignment_6_4() { return cSelectAssignment_6_4; }

		//SelectStatement
		public RuleCall getSelectSelectStatementParserRuleCall_6_4_0() { return cSelectSelectStatementParserRuleCall_6_4_0; }
		...
		//{CaseExpression}
		public Action getCaseExpressionAction_7_0() { return cCaseExpressionAction_7_0; }

		//"case"
		public Keyword getCaseKeyword_7_1() { return cCaseKeyword_7_1; }

		//caseExpression=SqlExpression?
		public Assignment getCaseExpressionAssignment_7_2() { return cCaseExpressionAssignment_7_2; }

		//SqlExpression
		public RuleCall getCaseExpressionSqlExpressionParserRuleCall_7_2_0() { return cCaseExpressionSqlExpressionParserRuleCall_7_2_0; }

		//cases+=Case+
		public Assignment getCasesAssignment_7_3() { return cCasesAssignment_7_3; }

		//Case
		public RuleCall getCasesCaseParserRuleCall_7_3_0() { return cCasesCaseParserRuleCall_7_3_0; }

		//("else" elseExpression=SqlExpression)?
		public Group getGroup_7_4() { return cGroup_7_4; }

		//"else"
		public Keyword getElseKeyword_7_4_0() { return cElseKeyword_7_4_0; }

		//elseExpression=SqlExpression
		public Assignment getElseExpressionAssignment_7_4_1() { return cElseExpressionAssignment_7_4_1; }

		//SqlExpression
		public RuleCall getElseExpressionSqlExpressionParserRuleCall_7_4_1_0() { return cElseExpressionSqlExpressionParserRuleCall_7_4_1_0; }
		...
		//{Function}
		public Action getFunctionAction_8_0() { return cFunctionAction_8_0; }
		...
		//all?="*"
		public Assignment getAllAssignment_8_3_0() { return cAllAssignment_8_3_0; }

		//"*"
		public Keyword getAllAsteriskKeyword_8_3_0_0() { return cAllAsteriskKeyword_8_3_0_0; }

		//arguments+=SqlExpression ("," arguments+=SqlExpression)*
		public Group getGroup_8_3_1() { return cGroup_8_3_1; }

		//arguments+=SqlExpression
		public Assignment getArgumentsAssignment_8_3_1_0() { return cArgumentsAssignment_8_3_1_0; }

		//SqlExpression
		public RuleCall getArgumentsSqlExpressionParserRuleCall_8_3_1_0_0() { return cArgumentsSqlExpressionParserRuleCall_8_3_1_0_0; }
		...
		//arguments+=SqlExpression
		public Assignment getArgumentsAssignment_8_3_1_1_1() { return cArgumentsAssignment_8_3_1_1_1; }

		//SqlExpression
		public RuleCall getArgumentsSqlExpressionParserRuleCall_8_3_1_1_1_0() { return cArgumentsSqlExpressionParserRuleCall_8_3_1_1_1_0; }
		...
		//{CastExpression}
		public Action getCastExpressionAction_9_0() { return cCastExpressionAction_9_0; }

		//"cast"
		public Keyword getCastKeyword_9_1() { return cCastKeyword_9_1; }

		//"("
		public Keyword getLeftParenthesisKeyword_9_2() { return cLeftParenthesisKeyword_9_2; }

		//expression=SqlExpression
		public Assignment getExpressionAssignment_9_3() { return cExpressionAssignment_9_3; }

		//SqlExpression
		public RuleCall getExpressionSqlExpressionParserRuleCall_9_3_0() { return cExpressionSqlExpressionParserRuleCall_9_3_0; }

		//"as"
		public Keyword getAsKeyword_9_4() { return cAsKeyword_9_4; }

		//type=SqliteDataType
		public Assignment getTypeAssignment_9_5() { return cTypeAssignment_9_5; }

		//SqliteDataType
		public RuleCall getTypeSqliteDataTypeEnumRuleCall_9_5_0() { return cTypeSqliteDataTypeEnumRuleCall_9_5_0; }
	...
	public class SingleSourceTableElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cTableReferenceCreateTableStatementCrossReference_1_0 = (CrossReference)cTableReferenceAssignment_1.eContents().get(0);
		private final RuleCall cTableReferenceCreateTableStatementIDTerminalRuleCall_1_0_1 = (RuleCall)cTableReferenceCreateTableStatementCrossReference_1_0.eContents().get(1);
		...
		public CrossReference getTableReferenceCreateTableStatementCrossReference_1_0() { return cTableReferenceCreateTableStatementCrossReference_1_0; }

		//ID
		public RuleCall getTableReferenceCreateTableStatementIDTerminalRuleCall_1_0_1() { return cTableReferenceCreateTableStatementIDTerminalRuleCall_1_0_1; }
	...
	public class DDLStatementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cAlterTableStatementParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		private final RuleCall cDropTableStatementParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		private final RuleCall cDropTriggerStatementParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		private final RuleCall cDropViewStatementParserRuleCall_6 = (RuleCall)cAlternatives.eContents().get(6);
		...
		//AlterTableStatement
		public RuleCall getAlterTableStatementParserRuleCall_3() { return cAlterTableStatementParserRuleCall_3; }

		//DropTableStatement
		public RuleCall getDropTableStatementParserRuleCall_4() { return cDropTableStatementParserRuleCall_4; }

		//DropTriggerStatement
		public RuleCall getDropTriggerStatementParserRuleCall_5() { return cDropTriggerStatementParserRuleCall_5; }

		//DropViewStatement
		public RuleCall getDropViewStatementParserRuleCall_6() { return cDropViewStatementParserRuleCall_6; }
	}
	...
	public class CreateTableStatementElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cColumnDefsAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cColumnDefsColumnDefParserRuleCall_5_0 = (RuleCall)cColumnDefsAssignment_5.eContents().get(0);
		private final Group cGroup_6 = (Group)cGroup.eContents().get(6);
		private final Keyword cCommaKeyword_6_0 = (Keyword)cGroup_6.eContents().get(0);
		private final Assignment cColumnDefsAssignment_6_1 = (Assignment)cGroup_6.eContents().get(1);
		private final RuleCall cColumnDefsColumnDefParserRuleCall_6_1_0 = (RuleCall)cColumnDefsAssignment_6_1.eContents().get(0);
		private final Group cGroup_7 = (Group)cGroup.eContents().get(7);
		private final Keyword cCommaKeyword_7_0 = (Keyword)cGroup_7.eContents().get(0);
		private final Assignment cConstraintsAssignment_7_1 = (Assignment)cGroup_7.eContents().get(1);
		private final RuleCall cConstraintsTableConstraintParserRuleCall_7_1_0 = (RuleCall)cConstraintsAssignment_7_1.eContents().get(0);
		...
		public Assignment getColumnDefsAssignment_5() { return cColumnDefsAssignment_5; }

		//ColumnDef
		public RuleCall getColumnDefsColumnDefParserRuleCall_5_0() { return cColumnDefsColumnDefParserRuleCall_5_0; }
		...
		//columnDefs+=ColumnDef
		public Assignment getColumnDefsAssignment_6_1() { return cColumnDefsAssignment_6_1; }

		//ColumnDef
		public RuleCall getColumnDefsColumnDefParserRuleCall_6_1_0() { return cColumnDefsColumnDefParserRuleCall_6_1_0; }
		...
		//TableConstraint
		public RuleCall getConstraintsTableConstraintParserRuleCall_7_1_0() { return cConstraintsTableConstraintParserRuleCall_7_1_0; }
	...
	public class CreateViewStatementElements extends AbstractParserRuleElementFinder {
		...
		//selectStatement=SelectStatement
		public Assignment getSelectStatementAssignment_5() { return cSelectStatementAssignment_5; }

		//SelectStatement
		public RuleCall getSelectStatementSelectStatementParserRuleCall_5_0() { return cSelectStatementSelectStatementParserRuleCall_5_0; }
	}
	...
	public class CreateTriggerStatementElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cWhenAlternatives_3_0 = (Alternatives)cWhenAssignment_3.eContents().get(0);
		private final Keyword cWhenBeforeKeyword_3_0_0 = (Keyword)cWhenAlternatives_3_0.eContents().get(0);
		private final Keyword cWhenAfterKeyword_3_0_1 = (Keyword)cWhenAlternatives_3_0.eContents().get(1);
		private final Keyword cWhenInsteadOfKeyword_3_0_2 = (Keyword)cWhenAlternatives_3_0.eContents().get(2);
		private final Alternatives cAlternatives_4 = (Alternatives)cGroup.eContents().get(4);
		private final Assignment cEventTypeAssignment_4_0 = (Assignment)cAlternatives_4.eContents().get(0);
		private final Keyword cEventTypeDeleteKeyword_4_0_0 = (Keyword)cEventTypeAssignment_4_0.eContents().get(0);
		private final Assignment cEventTypeAssignment_4_1 = (Assignment)cAlternatives_4.eContents().get(1);
		private final Keyword cEventTypeInsertKeyword_4_1_0 = (Keyword)cEventTypeAssignment_4_1.eContents().get(0);
		private final Group cGroup_4_2 = (Group)cAlternatives_4.eContents().get(2);
		private final Assignment cEventTypeAssignment_4_2_0 = (Assignment)cGroup_4_2.eContents().get(0);
		private final Keyword cEventTypeUpdateKeyword_4_2_0_0 = (Keyword)cEventTypeAssignment_4_2_0.eContents().get(0);
		private final Group cGroup_4_2_1 = (Group)cGroup_4_2.eContents().get(1);
		private final Keyword cOfKeyword_4_2_1_0 = (Keyword)cGroup_4_2_1.eContents().get(0);
		private final Assignment cUpdateColumnNamesAssignment_4_2_1_1 = (Assignment)cGroup_4_2_1.eContents().get(1);
		private final RuleCall cUpdateColumnNamesIDTerminalRuleCall_4_2_1_1_0 = (RuleCall)cUpdateColumnNamesAssignment_4_2_1_1.eContents().get(0);
		private final Group cGroup_4_2_1_2 = (Group)cGroup_4_2_1.eContents().get(2);
		private final Keyword cCommaKeyword_4_2_1_2_0 = (Keyword)cGroup_4_2_1_2.eContents().get(0);
		private final Assignment cUpdateColumnNamesAssignment_4_2_1_2_1 = (Assignment)cGroup_4_2_1_2.eContents().get(1);
		...
		private final Assignment cWhenExpressionAssignment_8_1 = (Assignment)cGroup_8.eContents().get(1);
		private final RuleCall cWhenExpressionSqlExpressionParserRuleCall_8_1_0 = (RuleCall)cWhenExpressionAssignment_8_1.eContents().get(0);
		private final Keyword cBeginKeyword_9 = (Keyword)cGroup.eContents().get(9);
		private final Group cGroup_10 = (Group)cGroup.eContents().get(10);
		private final Assignment cStatementsAssignment_10_0 = (Assignment)cGroup_10.eContents().get(0);
		private final RuleCall cStatementsDMLStatementParserRuleCall_10_0_0 = (RuleCall)cStatementsAssignment_10_0.eContents().get(0);
		...
		private final Assignment cStatementsAssignment_10_2_0 = (Assignment)cGroup_10_2.eContents().get(0);
		private final RuleCall cStatementsDMLStatementParserRuleCall_10_2_0_0 = (RuleCall)cStatementsAssignment_10_2_0.eContents().get(0);
		...
		public Alternatives getWhenAlternatives_3_0() { return cWhenAlternatives_3_0; }

		//"before"
		public Keyword getWhenBeforeKeyword_3_0_0() { return cWhenBeforeKeyword_3_0_0; }

		//"after"
		public Keyword getWhenAfterKeyword_3_0_1() { return cWhenAfterKeyword_3_0_1; }

		//"instead of"
		public Keyword getWhenInsteadOfKeyword_3_0_2() { return cWhenInsteadOfKeyword_3_0_2; }

		//eventType="delete" | eventType="insert" | eventType="update" ("of" updateColumnNames+=ID ("," updateColumnNames+=ID)*)?
		public Alternatives getAlternatives_4() { return cAlternatives_4; }

		//eventType="delete"
		public Assignment getEventTypeAssignment_4_0() { return cEventTypeAssignment_4_0; }

		//"delete"
		public Keyword getEventTypeDeleteKeyword_4_0_0() { return cEventTypeDeleteKeyword_4_0_0; }

		//eventType="insert"
		public Assignment getEventTypeAssignment_4_1() { return cEventTypeAssignment_4_1; }

		//"insert"
		public Keyword getEventTypeInsertKeyword_4_1_0() { return cEventTypeInsertKeyword_4_1_0; }

		//eventType="update" ("of" updateColumnNames+=ID ("," updateColumnNames+=ID)*)?
		public Group getGroup_4_2() { return cGroup_4_2; }

		//eventType="update"
		public Assignment getEventTypeAssignment_4_2_0() { return cEventTypeAssignment_4_2_0; }

		//"update"
		public Keyword getEventTypeUpdateKeyword_4_2_0_0() { return cEventTypeUpdateKeyword_4_2_0_0; }

		//("of" updateColumnNames+=ID ("," updateColumnNames+=ID)*)?
		public Group getGroup_4_2_1() { return cGroup_4_2_1; }

		//"of"
		public Keyword getOfKeyword_4_2_1_0() { return cOfKeyword_4_2_1_0; }

		//updateColumnNames+=ID
		public Assignment getUpdateColumnNamesAssignment_4_2_1_1() { return cUpdateColumnNamesAssignment_4_2_1_1; }

		//ID
		public RuleCall getUpdateColumnNamesIDTerminalRuleCall_4_2_1_1_0() { return cUpdateColumnNamesIDTerminalRuleCall_4_2_1_1_0; }

		//("," updateColumnNames+=ID)*
		public Group getGroup_4_2_1_2() { return cGroup_4_2_1_2; }

		//","
		public Keyword getCommaKeyword_4_2_1_2_0() { return cCommaKeyword_4_2_1_2_0; }

		//updateColumnNames+=ID
		public Assignment getUpdateColumnNamesAssignment_4_2_1_2_1() { return cUpdateColumnNamesAssignment_4_2_1_2_1; }

		//ID
		public RuleCall getUpdateColumnNamesIDTerminalRuleCall_4_2_1_2_1_0() { return cUpdateColumnNamesIDTerminalRuleCall_4_2_1_2_1_0; }
		...
		//"for each row"
		public Keyword getForEachRowForEachRowKeyword_7_0() { return cForEachRowForEachRowKeyword_7_0; }
		...
		//whenExpression=SqlExpression
		public Assignment getWhenExpressionAssignment_8_1() { return cWhenExpressionAssignment_8_1; }

		//SqlExpression
		public RuleCall getWhenExpressionSqlExpressionParserRuleCall_8_1_0() { return cWhenExpressionSqlExpressionParserRuleCall_8_1_0; }

		//"begin"
		public Keyword getBeginKeyword_9() { return cBeginKeyword_9; }
		...
		//DMLStatement
		public RuleCall getStatementsDMLStatementParserRuleCall_10_0_0() { return cStatementsDMLStatementParserRuleCall_10_0_0; }
		...
		//statements+=DMLStatement
		public Assignment getStatementsAssignment_10_2_0() { return cStatementsAssignment_10_2_0; }

		//DMLStatement
		public RuleCall getStatementsDMLStatementParserRuleCall_10_2_0_0() { return cStatementsDMLStatementParserRuleCall_10_2_0_0; }
	...
	public class AlterTableStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AlterTableStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cClauseAlterTableClauseParserRuleCall_3_0 = (RuleCall)cClauseAssignment_3.eContents().get(0);
		
		//AlterTableStatement:
		//	"alter" "table" table=[CreateTableStatement] clause=AlterTableClause;
		public ParserRule getRule() { return rule; }
		...
		//AlterTableClause
		public RuleCall getClauseAlterTableClauseParserRuleCall_3_0() { return cClauseAlterTableClauseParserRuleCall_3_0; }
	}
	...
	public class ColumnConstraintElements extends AbstractParserRuleElementFinder {
		...
		//{PrimaryKeyColumnConstraint} "primary key" (asc?="asc" | desc?="desc")? autoincrement?="autoincrement"? |
		//{NotNullConstraint} "not null" conflictClause=ConflictClause? | {DefaultConstraint} "default" defaultValue=DefaultValue
		public Alternatives getAlternatives() { return cAlternatives; }
	...
	private AlterTableStatementElements pAlterTableStatement;
