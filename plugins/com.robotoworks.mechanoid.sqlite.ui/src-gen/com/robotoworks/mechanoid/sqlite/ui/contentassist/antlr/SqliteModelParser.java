		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPrimaryExpressionAccess().getAlternatives_8_3(), "rule__PrimaryExpression__Alternatives_8_3");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getGroup_7_4(), "rule__PrimaryExpression__Group_7_4__0");
					put(grammarAccess.getPrimaryExpressionAccess().getGroup_8(), "rule__PrimaryExpression__Group_8__0");
					put(grammarAccess.getPrimaryExpressionAccess().getGroup_8_3_1(), "rule__PrimaryExpression__Group_8_3_1__0");
					put(grammarAccess.getPrimaryExpressionAccess().getGroup_8_3_1_1(), "rule__PrimaryExpression__Group_8_3_1_1__0");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getSourceAssignment_2_1(), "rule__PrimaryExpression__SourceAssignment_2_1");
					put(grammarAccess.getPrimaryExpressionAccess().getSourceAssignment_3_1_0_0(), "rule__PrimaryExpression__SourceAssignment_3_1_0_0");
					put(grammarAccess.getPrimaryExpressionAccess().getColumnAssignment_3_1_0_2(), "rule__PrimaryExpression__ColumnAssignment_3_1_0_2");
					put(grammarAccess.getPrimaryExpressionAccess().getColumnAssignment_3_1_1(), "rule__PrimaryExpression__ColumnAssignment_3_1_1");
					put(grammarAccess.getPrimaryExpressionAccess().getLiteralValueAssignment_4_1(), "rule__PrimaryExpression__LiteralValueAssignment_4_1");
					put(grammarAccess.getPrimaryExpressionAccess().getExpressionAssignment_5_2(), "rule__PrimaryExpression__ExpressionAssignment_5_2");
					put(grammarAccess.getPrimaryExpressionAccess().getNotAssignment_6_1(), "rule__PrimaryExpression__NotAssignment_6_1");
					put(grammarAccess.getPrimaryExpressionAccess().getExistsAssignment_6_2(), "rule__PrimaryExpression__ExistsAssignment_6_2");
					put(grammarAccess.getPrimaryExpressionAccess().getSelectAssignment_6_4(), "rule__PrimaryExpression__SelectAssignment_6_4");
					put(grammarAccess.getPrimaryExpressionAccess().getCaseExpressionAssignment_7_2(), "rule__PrimaryExpression__CaseExpressionAssignment_7_2");
					put(grammarAccess.getPrimaryExpressionAccess().getCasesAssignment_7_3(), "rule__PrimaryExpression__CasesAssignment_7_3");
					put(grammarAccess.getPrimaryExpressionAccess().getElseExpressionAssignment_7_4_1(), "rule__PrimaryExpression__ElseExpressionAssignment_7_4_1");
					put(grammarAccess.getPrimaryExpressionAccess().getNameAssignment_8_1(), "rule__PrimaryExpression__NameAssignment_8_1");
					put(grammarAccess.getPrimaryExpressionAccess().getAllAssignment_8_3_0(), "rule__PrimaryExpression__AllAssignment_8_3_0");
					put(grammarAccess.getPrimaryExpressionAccess().getArgumentsAssignment_8_3_1_0(), "rule__PrimaryExpression__ArgumentsAssignment_8_3_1_0");
					put(grammarAccess.getPrimaryExpressionAccess().getArgumentsAssignment_8_3_1_1_1(), "rule__PrimaryExpression__ArgumentsAssignment_8_3_1_1_1");
					put(grammarAccess.getPrimaryExpressionAccess().getExpressionAssignment_9_3(), "rule__PrimaryExpression__ExpressionAssignment_9_3");
					put(grammarAccess.getPrimaryExpressionAccess().getTypeAssignment_9_5(), "rule__PrimaryExpression__TypeAssignment_9_5");
