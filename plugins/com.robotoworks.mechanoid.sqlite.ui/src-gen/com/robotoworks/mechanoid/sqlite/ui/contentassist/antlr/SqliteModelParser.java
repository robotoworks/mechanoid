		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAlterTableStatementAccess().getGroup(), "rule__AlterTableStatement__Group__0");
					...
					put(grammarAccess.getAlterTableStatementAccess().getTableAssignment_2(), "rule__AlterTableStatement__TableAssignment_2");
					put(grammarAccess.getAlterTableStatementAccess().getClauseAssignment_3(), "rule__AlterTableStatement__ClauseAssignment_3");
