		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getResultColumnAllAccess().getAlternatives_1(), "rule__ResultColumnAll__Alternatives_1");
					...
					put(grammarAccess.getSelectExpressionAccess().getGroup_6_2(), "rule__SelectExpression__Group_6_2__0");
					...
					put(grammarAccess.getResultColumnAllAccess().getGroup(), "rule__ResultColumnAll__Group__0");
					put(grammarAccess.getResultColumnAllAccess().getGroup_1_0(), "rule__ResultColumnAll__Group_1_0__0");
					put(grammarAccess.getResultColumnExpressionAccess().getGroup(), "rule__ResultColumnExpression__Group__0");
					put(grammarAccess.getResultColumnExpressionAccess().getGroup_2(), "rule__ResultColumnExpression__Group_2__0");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getColumnAssignment_0_3(), "rule__PrimaryExpression__ColumnAssignment_0_3");
					put(grammarAccess.getPrimaryExpressionAccess().getColumnAssignment_1_3(), "rule__PrimaryExpression__ColumnAssignment_1_3");
					put(grammarAccess.getPrimaryExpressionAccess().getSourceAssignment_2_1_0(), "rule__PrimaryExpression__SourceAssignment_2_1_0");
					put(grammarAccess.getPrimaryExpressionAccess().getColumnAssignment_2_2(), "rule__PrimaryExpression__ColumnAssignment_2_2");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getArugmentsAssignment_7_3_1_1_1(), "rule__PrimaryExpression__ArugmentsAssignment_7_3_1_1_1");
					...
					put(grammarAccess.getSelectExpressionAccess().getSelectListAssignment_3(), "rule__SelectExpression__SelectListAssignment_3");
					put(grammarAccess.getSelectExpressionAccess().getSourceAssignment_4_1(), "rule__SelectExpression__SourceAssignment_4_1");
					put(grammarAccess.getSelectExpressionAccess().getWhereExpressionAssignment_5_1(), "rule__SelectExpression__WhereExpressionAssignment_5_1");
					put(grammarAccess.getSelectExpressionAccess().getGroupByExpressionsAssignment_6_1(), "rule__SelectExpression__GroupByExpressionsAssignment_6_1");
					put(grammarAccess.getSelectExpressionAccess().getGroupByExpressionsAssignment_6_2_1(), "rule__SelectExpression__GroupByExpressionsAssignment_6_2_1");
					put(grammarAccess.getSelectExpressionAccess().getHavingExpressionAssignment_7_1(), "rule__SelectExpression__HavingExpressionAssignment_7_1");
					...
					put(grammarAccess.getResultColumnAllAccess().getReferenceAssignment_1_0_0(), "rule__ResultColumnAll__ReferenceAssignment_1_0_0");
					put(grammarAccess.getResultColumnExpressionAccess().getExpressionAssignment_1(), "rule__ResultColumnExpression__ExpressionAssignment_1");
					put(grammarAccess.getResultColumnExpressionAccess().getNameAssignment_2_1(), "rule__ResultColumnExpression__NameAssignment_2_1");
					...
					put(grammarAccess.getCreateTriggerStatementAccess().getTableNameAssignment_6(), "rule__CreateTriggerStatement__TableNameAssignment_6");
					...
					put(grammarAccess.getAlterTableStatementAccess().getNameAssignment_2(), "rule__AlterTableStatement__NameAssignment_2");
					...
					put(grammarAccess.getDropTableStatementAccess().getNameAssignment_3(), "rule__DropTableStatement__NameAssignment_3");
					put(grammarAccess.getDropTriggerStatementAccess().getIfExistsAssignment_2(), "rule__DropTriggerStatement__IfExistsAssignment_2");
					put(grammarAccess.getDropTriggerStatementAccess().getNameAssignment_3(), "rule__DropTriggerStatement__NameAssignment_3");
					put(grammarAccess.getDropViewStatementAccess().getIfExistsAssignment_2(), "rule__DropViewStatement__IfExistsAssignment_2");
					put(grammarAccess.getDropViewStatementAccess().getNameAssignment_3(), "rule__DropViewStatement__NameAssignment_3");
