		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCreateTriggerStatementAccess().getWhenAlternatives_3_0(), "rule__CreateTriggerStatement__WhenAlternatives_3_0");
					put(grammarAccess.getCreateTriggerStatementAccess().getAlternatives_4(), "rule__CreateTriggerStatement__Alternatives_4");
					...
					put(grammarAccess.getCreateTableStatementAccess().getGroup_6(), "rule__CreateTableStatement__Group_6__0");
					...
					put(grammarAccess.getCreateTriggerStatementAccess().getGroup_4_2(), "rule__CreateTriggerStatement__Group_4_2__0");
					put(grammarAccess.getCreateTriggerStatementAccess().getGroup_4_2_1(), "rule__CreateTriggerStatement__Group_4_2_1__0");
					put(grammarAccess.getCreateTriggerStatementAccess().getGroup_4_2_1_2(), "rule__CreateTriggerStatement__Group_4_2_1_2__0");
					put(grammarAccess.getCreateTriggerStatementAccess().getGroup_8(), "rule__CreateTriggerStatement__Group_8__0");
					put(grammarAccess.getCreateTriggerStatementAccess().getGroup_10(), "rule__CreateTriggerStatement__Group_10__0");
					put(grammarAccess.getCreateTriggerStatementAccess().getGroup_10_2(), "rule__CreateTriggerStatement__Group_10_2__0");
					...
					put(grammarAccess.getCreateTableStatementAccess().getNameAssignment_3(), "rule__CreateTableStatement__NameAssignment_3");
					put(grammarAccess.getCreateTableStatementAccess().getColumnDefsAssignment_5(), "rule__CreateTableStatement__ColumnDefsAssignment_5");
					put(grammarAccess.getCreateTableStatementAccess().getColumnDefsAssignment_6_1(), "rule__CreateTableStatement__ColumnDefsAssignment_6_1");
					put(grammarAccess.getCreateTableStatementAccess().getConstraintsAssignment_7_1(), "rule__CreateTableStatement__ConstraintsAssignment_7_1");
					put(grammarAccess.getCreateViewStatementAccess().getNameAssignment_3(), "rule__CreateViewStatement__NameAssignment_3");
					put(grammarAccess.getCreateViewStatementAccess().getSelectStatementAssignment_5(), "rule__CreateViewStatement__SelectStatementAssignment_5");
					put(grammarAccess.getCreateTriggerStatementAccess().getNameAssignment_2(), "rule__CreateTriggerStatement__NameAssignment_2");
					put(grammarAccess.getCreateTriggerStatementAccess().getWhenAssignment_3(), "rule__CreateTriggerStatement__WhenAssignment_3");
					put(grammarAccess.getCreateTriggerStatementAccess().getEventTypeAssignment_4_0(), "rule__CreateTriggerStatement__EventTypeAssignment_4_0");
					put(grammarAccess.getCreateTriggerStatementAccess().getEventTypeAssignment_4_1(), "rule__CreateTriggerStatement__EventTypeAssignment_4_1");
					put(grammarAccess.getCreateTriggerStatementAccess().getEventTypeAssignment_4_2_0(), "rule__CreateTriggerStatement__EventTypeAssignment_4_2_0");
					put(grammarAccess.getCreateTriggerStatementAccess().getUpdateColumnNamesAssignment_4_2_1_1(), "rule__CreateTriggerStatement__UpdateColumnNamesAssignment_4_2_1_1");
					put(grammarAccess.getCreateTriggerStatementAccess().getUpdateColumnNamesAssignment_4_2_1_2_1(), "rule__CreateTriggerStatement__UpdateColumnNamesAssignment_4_2_1_2_1");
					put(grammarAccess.getCreateTriggerStatementAccess().getTableAssignment_6(), "rule__CreateTriggerStatement__TableAssignment_6");
					put(grammarAccess.getCreateTriggerStatementAccess().getForEachRowAssignment_7(), "rule__CreateTriggerStatement__ForEachRowAssignment_7");
					put(grammarAccess.getCreateTriggerStatementAccess().getWhenExpressionAssignment_8_1(), "rule__CreateTriggerStatement__WhenExpressionAssignment_8_1");
					put(grammarAccess.getCreateTriggerStatementAccess().getStatementsAssignment_10_0(), "rule__CreateTriggerStatement__StatementsAssignment_10_0");
					put(grammarAccess.getCreateTriggerStatementAccess().getStatementsAssignment_10_2_0(), "rule__CreateTriggerStatement__StatementsAssignment_10_2_0");
