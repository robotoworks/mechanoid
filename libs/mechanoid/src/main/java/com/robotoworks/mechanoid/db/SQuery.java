...
public class SQuery {
     ...
     *
     * @param query A query to use as a sub-expression
     * @return
     */
    ...
    public <T extends ActiveRecord> List<T> select(Uri uri) {
        ...
        return provider.selectRecords(uri, this, null);
    }
    ...
    public <T extends ActiveRecord> List<T> select(Uri uri, String sortOrder) {
        ...
        return provider.selectRecords(uri, this, sortOrder);
    }
    ...
    public <T extends ActiveRecord> Map<String, T> selectMap(Uri uri, String keyColumnName, String... groupBy) {
        ...
        return provider.selectRecordMap(uri, this, keyColumnName);
    }
    ...
    private MechanoidContentProvider getContentProvider(Uri uri) {
        ...
        return (MechanoidContentProvider) client.getLocalContentProvider();
    }
    ...
    public List<Long> selectLongList(Uri uri, String column, String orderBy) {
        ...
        try {
            ...
            List<Long> list = new ArrayList<>(cursor.getCount());
    ...
    public static class Async extends AsyncQueryHandler {
        ...
        public AsyncQuery startQuery(AsyncQueryCallback callback, Uri uri,
            ...
            WeakReference<AsyncQuery> queryRef = new WeakReference<>(query);
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            @SuppressWarnings("unchecked") WeakReference<AsyncQuery> queryRef = (WeakReference<AsyncQuery>) cookie;
